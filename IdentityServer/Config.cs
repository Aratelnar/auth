        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                ...
                new Client
                {
                    ...
                    // NOTE: куда отправлять после логина
                    RedirectUris = { "https://localhost:8001/authentication/login-callback", "/authentication/login-callback" },

                    // NOTE: куда предлагать перейти после логаута
                    PostLogoutRedirectUris = { "https://localhost:8001/authentication/logout-callback", "/authentication/logout-callback" },
